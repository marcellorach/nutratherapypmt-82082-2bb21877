...
const FALLBACK_COVERAGE: CoverageItem[] = [
  ...
  { id: "digital-twin", pillar: "Digital Twin & Projeções", title_pt: "Digital Twin & projeções — DOIS motores distintos: (a) progressão de condição com nutracêutico = SIGMOIDE calibrada 1/(1+exp(-k·(t−t50))) em condition-progression-engine.ts; (b) curva de envelhecimento biológico por raça = Gompertz em breed_aging_curves/project-pet-trajectory. NÃO descreva (a) como Gompertz.", expected: "active", evidence: "condition-progression-engine.ts + breed_aging_curves + project-pet-trajectory" },
