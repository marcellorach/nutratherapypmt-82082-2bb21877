...
export const changelog: ChangelogEntry[] = [
  {
    ...
    "area": "admin",
    "status": "entregue",
    "title": "Governança de modelos, Fase 1: tela única e inventário honesto",
    "bullets": [
    ...
    "files": [
      ...
      "scripts/__tests__/ai-inventory.test.mjs",
  ...
  },
  {
    ...
    "area": "admin",
    "status": "entregue",
    "title": "Modelo de leitura de PDF escolhido na tela de modelos por tarefa",
    "bullets": [
    ...
    "files": [
      ...
      "src/components/administrador/configuracoes/AIModelSelector.tsx",
      "src/components/administrador/settings/panels/EnginesPromptsPanel.tsx",
      "src/hooks/ntai/useProcessingLogic.ts",
      "src/hooks/ntai/useVetGraphRAGConfig.ts",
      "src/i18n.ts"
    ],
    "i18nVersion": "1.134.0"
  },
  ...
  },
  {
    ...
    "area": "admin",
    "status": "entregue",
    "title": "System Prompts: versão Senex (7.2.4), selo unificado nas 3 abas e audit log",
    "bullets": [
    ...
    "files": [
      "src/config/app-version.ts",
      "src/components/administrador/configuracoes/PromptsIntegrityBadge.tsx",
  ...
  },
  {
    ...
    "area": "meta",
    "status": "entregue",
    "title": "Auditoria v7.2.0: split clínico no snapshot + KG honesto + Gompertz erradicado",
    "bullets": [
  ...
  },
  {
    ...
    "area": "meta",
    "status": "entregue",
    "title": "Drift-guard A+B+C+D dobrado no pipeline da auditoria",
    "bullets": [
    ...
    "files": [
      "scripts/drift-guard.mjs",
      "public/drift-report.json",
      "supabase/functions/generate-audit/index.ts",
      "supabase/functions/_shared/system-prompts.ts"
    ],
    "i18nVersion": "1.118.3"
  ...
  },
  {
    ...
    "area": "meta",
    "status": "entregue",
    "title": "Sweep \"RWD ≠ sintético\" em todas as superfícies + ponteiro de circularidade (Bloco 3)",
    "bullets": [
    ...
    "files": [
      "src/components/administrador/ai-insights/mockInsights.ts",
      ".lovable/memory/constraints/synthetic-cohort-not-rwd.md",
      "src/locales/pt/translation.json",
      "src/locales/en/translation.json",
      "src/i18n.ts"
    ],
  ...
  },
  {
    ...
    "area": "clinical-pipeline",
    "status": "entregue",
    "title": "IA Hardening Cards #3+#4: abstain válido + provenance tipada + remoção do simpleExtraction",
    "bullets": [
      ...
      "Eixos de proveniência ativos (para o Bloco 4 manter ortogonalidade): (1) `RecommendationSource: 'knowledge_graph'|'hybrid'|'llm_fallback'` — origem do envelope; (2) `CompoundProvenance: 'KG-backed'|'AI-enriched'|'AI-generated'` — origem por composto; (3) `DisclaimerType: 'none'|'low_confidence'|'no_kg_data'` — tarja de UI; (4) `source_api` em `kg-evidence-gap-fill` — proveniência interna que passa pelo gate de curadoria (NÃO é runtime, não compete com os 3 acima); (5) Eixo A `evidence-levels` (`veryHigh`..`veryLow`) — qualidade científica, ORTOGONAL ao Eixo B.",
      "Fronteira reafirmada: `abstain ≠ \"KG vazio\"`. abstain = \"não dá para dizer nada com responsabilidade, nem marcado\". O fallback do tutor para LLM avançada está PRESERVADO; passa a ser rastreável via `source+disclaimer+evidenceLevel`.",
      "Files: `supabase/functions/hybrid-recommendation/index.ts`, `supabase/functions/extract-pet-clinical-data/index.ts`, `src/types/recommendation-confidence.ts`"
    ],
    "files": [
      "supabase/functions/extract-pet-clinical-data/index.ts",
      "src/types/recommendation-confidence.ts",
      "src/rules/general/evidence-levels.ts",
      "supabase/functions/hybrid-recommendation/index.ts"
    ],
    "i18nVersion": "1.118.1"
  },
  ...
  },
  {
    ...
    "area": "admin",
    "status": "entregue",
    "title": "Gerenciamento in-app de chaves de API (sem Lovable Cloud)",
    "bullets": [
  ...
  },
  {
    ...
    "area": "admin",
    "status": "entregue",
    "title": "Versionamento unificado: SENEX_VERSION como fonte única",
    "bullets": [
    ...
    "files": [
      "src/components/system/VersionBadge.tsx",
  ...
  },
  {
    ...
    "area": "infra",
    "status": "entregue",
    "title": "Sprint 3 utilitários: `enrich-pet-food-product`, `document-chat`, `suggest-taxonomy-terms` no registro único",
    "bullets": [
    ...
    "files": [
      ...
      "supabase/functions/suggest-taxonomy-terms/index.ts",
  ...
  },
  {
    ...
    "area": "meta",
    "status": "entregue",
    "title": "Meta-studies: `chat-meta-study` e `evaluate-meta-study-reliability` no registro único",
    "bullets": [
    ...
    "files": [
      "supabase/functions/_shared/system-prompts.ts",
      "supabase/functions/chat-meta-study/index.ts",
      "supabase/functions/evaluate-meta-study-reliability/index.ts"
    ],
    "i18nVersion": "n/a"
  },
  {
  ...
  },
  {
    ...
    "area": "admin",
    "status": "entregue",
    "title": "Senex 7.0: Painel de Priorizações com histórico + Population Insights com proveniência",
    "bullets": [
    ...
    "files": [
      ...
      "src/components/administrador/priorizacoes/OriginalityDialog.tsx",
      "src/components/administrador/priorizacoes/InsightDrillDownDialog.tsx",
  ...
  },
  {
    ...
    "area": "admin",
    "status": "entregue",
    "title": "Observabilidade e DnD na análise de cohorts",
    "bullets": [
    ...
    "files": [
      ...
      "src/components/administrador/priorizacoes/PrioritizationBoard.tsx",
      "src/components/administrador/priorizacoes/PopulationInsightsV0.tsx",
      "src/components/administrador/priorizacoes/dnd/KanbanDnd.tsx"
    ],
    "i18nVersion": "1.112.0"
  },
  {
  ...
  },
  {
    ...
    "area": "admin",
    "status": "entregue",
    "title": "Depósito de estudos arquiteturais ganha citações ricas; ilustrações do Kanban removidas",
    "bullets": [
    ...
    "files": [
      "src/components/administrador/fundamentos/MetaStudyDetailedCard.tsx",
      "src/pages/administrador/FundamentosTab.tsx",
  ...
  },
  {
    ...
    "area": "admin",
    "status": "entregue",
    "title": "Meta-Estudos \"Stanford-grade\": capas IA, badge de Core Rules e chat contextual",
    "bullets": [
    ...
    "files": [
      "supabase/functions/generate-meta-study-cover/index.ts",
      "supabase/functions/chat-meta-study/index.ts",
      "src/components/administrador/fundamentos/MetaStudyChatDialog.tsx",
      "src/components/administrador/fundamentos/CoreRulesEvidenceBadge.tsx",
      "src/components/administrador/fundamentos/MetaStudyKanban.tsx"
    ],
    "i18nVersion": "1.100.0"
  },
  {
    ...
    "area": "admin",
    "status": "entregue",
    "title": "Kanban Meta-Estudos: breakdown de confiabilidade inline",
    "bullets": [
  ...
  },
  {
    ...
    "area": "meta",
    "status": "entregue",
    "title": "Docs: contrato `callAITask` em TECHNICAL_DECISIONS + GRAPHRAG",
    "bullets": [
