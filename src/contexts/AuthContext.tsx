...
/** Canonical role list lives in src/config/app-roles.ts (mirrored by the database). */
export type { AppRole } from '@/config/app-roles';
import type { AppRole } from '@/config/app-roles';
