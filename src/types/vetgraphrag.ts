// VetGraphRAG Types (formerly NTAI)
// Provides types for the VetGraphRAG knowledge extraction pipeline
...
export interface VetGraphRAGAnalysisResult {
  studyId: string;
  qualityScore: number;
...
// VetGraphRAG renamed types (main exports)
export type VetGraphRAGConditionTag = NtaiConditionTag;
export type VetGraphRAGNutraceuticalTag = NtaiNutraceuticalTag;
export type VetGraphRAGInteractionTag = NtaiInteractionTag;
export type VetGraphRAGSideEffectTag = NtaiSideEffectTag;
export type VetGraphRAGAnalysisStage = NtaiAnalysisStage;
