...
const AnalyticsTab: React.FC = () => {
  ...
  return (
    <div className="space-y-8 p-6">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
          ...
          <Card className="h-fit">
            <CardHeader className="pb-4">
              <CardTitle className="flex items-center gap-2">
                {t('analytics.efficacy.title')}
                <div className="h-2 w-2 bg-green-500 rounded-full" />
              </CardTitle>
              <CardDescription>
                {t('analytics.efficacy.description')}
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-100">
                  <div className="text-sm font-medium text-green-700">{t('analytics.efficacy.highest')}</div>
                ...
                <div className="p-4 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg border border-blue-100">
                  <div className="text-sm font-medium text-blue-700">{t('analytics.efficacy.lowest')}</div>
                  ...
                  <div className="text-xs text-blue-600">
                    {efficacyData.reduce((min, item) => item.contraindications < min.contraindications ? item : min, efficacyData[0])?.contraindications || 0} {t('analytics.efficacy.contraindications')}
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="h-fit">
            <CardHeader className="pb-4">
              ...
              <CardDescription>
                {t('analytics.pipeline.description')}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg border border-blue-100">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-sm font-medium text-blue-700">{t('analytics.pipeline.testing')}</div>
                        <div className="text-xs text-blue-600">{t('analytics.pipeline.testingDesc')}</div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-amber-50 rounded-lg border border-amber-100">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-sm font-medium text-amber-700">{t('analytics.pipeline.development')}</div>
                        <div className="text-xs text-amber-600">{t('analytics.pipeline.developmentDesc')}</div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg border border-green-100">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-sm font-medium text-green-700">{t('analytics.pipeline.validated')}</div>
                        <div className="text-xs text-green-600">{t('analytics.pipeline.validatedDesc')}</div>
                      </div>
                    </div>
                ...
                <div className="pt-4 border-t space-y-3">
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-muted-foreground">{t('analytics.pipeline.validationRate')}</span>
                    <span className="font-semibold text-green-600">78.5%</span>
                  </div>
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-muted-foreground">{t('analytics.pipeline.avgTime')}</span>
                    <span className="font-semibold">4.2 {t('analytics.pipeline.months')}</span>
                  </div>
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-muted-foreground">{t('analytics.pipeline.nextValidations')}</span>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          <h2 className="text-xl font-semibold">{t('analytics.sections.performance')}</h2>
          <div className="h-px bg-border flex-1" />
        </div>
