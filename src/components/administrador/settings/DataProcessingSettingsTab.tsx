  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold">Configurações - Processamento de Dados</h2>
          <p className="text-sm text-gray-500">Configure engines, prompts e convenções específicas para o Processamento de Dados</p>
        </div>
