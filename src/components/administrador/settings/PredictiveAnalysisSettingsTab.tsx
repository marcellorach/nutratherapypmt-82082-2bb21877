    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="engines" className="mt-6">
          <EnginesPromptsPanel section="predictive-analysis" />
        </TabsContent>
        <TabsContent value="conventions" className="mt-6">
          <ConventionsPanel section="predictive-analysis" />
        </TabsContent>
        <TabsContent value="usage" className="mt-6">
          <UsagePanel section="predictive-analysis" />
        </TabsContent>
      </Tabs>
    </div>
  );
...
export default PredictiveAnalysisSettingsTab;
