...
export const predictiveModelsData: PredictiveModel[] = [
  {
    ...
    algorithmShortName: 'PetLove Nutra',
    status: 'state-of-art',
  ...
  },
  {
    ...
    algorithmShortName: 'PetLove CuBe',
    status: 'mature',
  ...
  },
  {
    ...
    modelName: 'Segmentação por Tratabilidade',
    algorithm: 'K-Means Clustering + Decision Trees',
    algorithmShortName: 'PetLove Trat',
    status: 'growing',
    currentAccuracy: 81.2,
    trainedAt: '2025-09-12',
    description: 'Classifica pets em grupos de tratabilidade baseado em potencial de resposta a intervenções nutracêuticas, otimizando personalização de protocolos.',
  ...
  },
  {
    ...
    algorithmShortName: 'PetLove Prev',
    status: 'initial',
