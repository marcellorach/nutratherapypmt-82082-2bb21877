...
const MATRIX = [
  {
    ...
    status: 'implemented',
    honest_name: 'Triple Graph Construction (MedGraphRAG-style)',
    pointer: 'supabase/functions/extract-study-entities/, supabase/functions/generate-triplets/',
    notes: 'Document/chunk/entity hierarchy persists in pgvector + L0–L4 tables.',
  },
  {
    ...
    status: 'inspiration',
    honest_name: 'Generate + heuristic scoring (0.65–0.75) + auto-approve ≥ 0.50 + HITL',
  ...
  },
  {
    ...
    status: 'implemented',
    honest_name: 'Auto-approve ≥ 0.50 + manual curation board',
    pointer: 'supabase/functions/generate-triplets/, src/components/administrador/estudos/curation/',
    notes: 'Threshold currently hard-coded; future work makes it admin-configurable.',
  },
  {
    ...
    status: 'implemented',
    honest_name: 'Sigmoid projection engine',
    pointer: 'src/services/condition-progression-engine.ts, src/hooks/usePetTrajectoryProjection.ts',
    notes: 'Severity weighted by baseline; covered by unit tests.',
  },
  {
